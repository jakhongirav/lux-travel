...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="bg-navy text-white" id="contact">
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4">{translations.footer.contact}</h3>
        ...
        <div className="flex justify-center">
          <p className="text-white/70 text-sm">
            &copy; {currentYear} LuxTravel. {translations.footer.allRightsReserved}
          </p>
        </div>
      </div>
    </footer>
